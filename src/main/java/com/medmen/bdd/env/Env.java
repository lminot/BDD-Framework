...
public class Env 
{
	...
	public static String getBrowserName()
	{
		...
		if(cloudBrowserConfigFile != null)
		{
			...
			try {
				...
				InputStream input = new FileInputStream(currentPath+"/src/main/java/com.medmen.bdd.cloudBrowserConfigs/"+cloudBrowserConfigFile+".properties");
				input.close();
	...
	public static WebDriver SaucelabDriver(){
		...
		try {
			InputStream input = new FileInputStream(currentPath+"/src/main/java/com.medmen.bdd.cloudPlatformConfigs/saucelab.properties");
			prop.load(input);
	    	...
	    	input = new FileInputStream(currentPath+"/src/main/java/com.medmen.bdd.cloudBrowserConfigs/"+cloudBrowserConfigFile+".properties");
			prop.load(input);
			enuKeys = prop.keys();
			while (enuKeys.hasMoreElements()) {
				String key = (String) enuKeys.nextElement();
