...
public class StatemadeStepDefs implements BaseTest {
  ...
  public void i_am_taken_to_the_product_type_page() {
    ...
    assertEquals(
        "Our expertly designed, industry-leading"
            + " products are grown in your state, for your "
            + "desired state. enjoy the  [statemade]  "
            + "effect you want, the way you want it.",
  ...
  public void iSelectTheProduct(String productType) {
  ...
  public void theProperPageIsDisplayed(String productType) {
